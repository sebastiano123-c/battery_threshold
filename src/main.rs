...
//     battery.get_bat_capacity();
//     battery.get_bat_start_threshold();
//     battery.get_bat_end_threshold();
//     battery.get_bat_property("power_now");
//
...
//
//         // Get status
//         // let status_button = Button::with_label("Get battery status");
//         // status_button.connect_clicked(get_battery_status(&battery_name_entry.text()));
//         // print_type_of(&battery_name_entry.text());
//
//         // Set button
